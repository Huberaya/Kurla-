# Demande de prix — Après-shampoing rincé

**Émetteur** : KURLA
**Interlocuteur** : ⟨à compléter⟩
**Courriel de réponse** : ⟨à compléter⟩
**Date d'émission** : 2026-08-29
**Vague de sourcing** : vague-1
**Référence interne du besoin** : `vague-1-apres-shampoing-rince`
**Réponse attendue avant** : ⟨à compléter⟩

---

## 1. Ce que nous cherchons

**Besoin** : Après-shampoing rincé
**Catégorie** : soin capillaire

**Pourquoi ce besoin existe** :

Trou n°1 du catalogue. Le catalogue lave (p2) et scelle (p1), mais ne démêle pas sous la douche. Sur cheveux 4A-4C, l’après-shampoing est le geste qui précède tous les autres ; son absence rend la routine incomplète. C’est le premier produit à sourcer.
...
1. **Personne Responsable (UE)**
   _Pourquoi : Un cosmétique mis sur le marché européen exige une Personne Responsable établie dans l’Union, dont l’adresse figure sur l’étiquette._
2. **Dossier d’information produit (PIF)**
   _Pourquoi : Le dossier d’information produit doit exister avant la mise sur le marché et être tenu à disposition des autorités._
3. **Rapport de sécurité (CPSR)**
   _Pourquoi : Le rapport de sécurité signé par un évaluateur qualifié est la pièce maîtresse du PIF. Sans CPSR, le produit ne peut pas être notifié._
4. **Notification CPNP**
   _Pourquoi : La notification sur le portail CPNP est obligatoire avant la première mise sur le marché dans l’Union._
5. **BPF — ISO 22716**
   _Pourquoi : Les bonnes pratiques de fabrication cosmétique (ISO 22716) sont le socle attendu d’un façonnier._
6. **Certificat d’analyse**
   _Pourquoi : Le certificat d’analyse atteste la conformité du lot livré à la spécification._
7. **Attestation sans microplastique**
   _Pourquoi : La loi AGEC interdit les microplastiques dans les cosmétiques rincés au-delà de 0,01 % de la masse depuis le 1er janvier 2026._
...
| Conditions de paiement | ⟨à compléter⟩ |
...
_Document généré par la plateforme KURLA à partir du besoin `vague-1-apres-shampoing-rince`.
Les champs marqués ⟨à compléter⟩ doivent être complétés avant envoi._