...
### ⬜ À faire (12)
**3** Rendu serveur · **11** Diagnostic photo · **20** i18n/devises/TVA · **32** Recherche visuelle · **33** Scan code-barres · **36** Climat/eau dure *(voir détail ci-dessous)* · **37** Pages SEO générées · **38** Contenu personnalisé · **41** Espace marque · **42** Application mobile · **43** Export/suppression 1 clic · **46** Tests Supabase réels *(l'action 4 est livrée ; le banc d'intégration A/B reste à rejouer à chaque migration)*

### 🚫 Exclues volontairement (3)
**48** Virtual try-on coiffure · **49** Maquillage virtuel · **50** Place de marché créateurs

> **Compte : 30 + 1 + 4 + 12 + 3 = 50.** Vérifié par relecture programmatique de la matrice : 50 identifiants uniques, aucun doublon, aucun manquant.
