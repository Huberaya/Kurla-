...
## 2026-09-17 — Kurla Skin = Kurla Hair : même configuration (Agent Arena, `b968d3b`, poussé)
- Demande utilisateur : « les onglets et les sections pareils » entre les deux espaces.
- Nav : groupe « Gouvernance Skin » retiré (onglets skin_overview / skin_readiness / skin_catalog démontés) ; les deux espaces ont désormais exactement les 6 mêmes familles et les mêmes onglets ; Skin arrive sur « Tableau de bord commercial » comme Hair ; libellé pros unifié (« Certifications Pro »).
- Sections : toutes les injections `workspace === 'skin'` retirées des onglets partagés (demande, catalogue, pilotage, fournisseurs, négocier, recevoir, lots).
