...
export const ASSORTMENT_NEEDS: AssortmentNeed[] = [
  ...
  // ----------------------------------------------------- OUTILS & PROTECTION
  {
    ...
    why: 'Le bonnet/taie en satin est un réflexe de rétention hydratante et de durabilité des coiffures. Achat récurrent, forte marge, mais aucun fournisseur n\'est encore identifié.',
    priority: 'important',
  ...
  },
  {
    ...
    why: 'Les accessoires prolongent l\'usage des produits et complètent le panier moyen. Aucun fournisseur accessoire n\'est encore référencé.',
    priority: 'later',
