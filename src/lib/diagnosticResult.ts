...
const LABELS: Record<string, string> = {
  ...
  poils_incarnes: 'Poils incarnés / rasage', taches_hormonales: 'Taches hormonales', grain_de_poulet: 'Grain de poulet', secheresse_corps: 'Sécheresse du corps', rougeurs: 'Rougeurs', points_noirs: 'Points noirs', grain_irregulier: 'Grain irrégulier', cicatrices: 'Cicatrices', rides: 'Rides', fermete: 'Fermeté', cernes: 'Cernes',
