...
const LABELS: Record<string, string> = {
  ...
  poils_incarnes: 'Poils incarnés / rasage', taches_hormonales: 'Taches hormonales', rougeurs: 'Rougeurs', points_noirs: 'Points noirs', grain_irregulier: 'Grain irrégulier', cicatrices: 'Cicatrices', rides: 'Rides', fermete: 'Fermeté', cernes: 'Cernes',
