...
const LABELS: Record<string, string> = {
  ...
  poils_incarnes: 'Poils incarnés / rasage', taches_hormonales: 'Taches hormonales', assombrissement_plis: 'Assombrissement des plis', grain_de_poulet: 'Grain de poulet', secheresse_corps: 'Sécheresse du corps', port_maquillage: 'Maquillage', leveres_assombries: 'Lèvres', picking: 'Picking / tripoter', rougeurs: 'Rougeurs', points_noirs: 'Points noirs', grain_irregulier: 'Grain irrégulier', cicatrices: 'Cicatrices', rides: 'Rides', fermete: 'Fermeté', cernes: 'Cernes',
