...
export const LAUNCH_PRODUCTS: LaunchProduct[] = [
  ...
  // ── GAP 2026-09-09 — 23 innovations mondiales manquantes (vérif Amazon/Alibaba/AliExpress/Temu/CES 2026) ──
  // P1 MUST J0 : machines auto tresses/locs + heatless + diagnostic HW (0 carton, 24–48h)
  { id: 'p55', name: 'Machine à tresser électrique automatique USB 360° (EXLEAF 2026)', category: 'Accessoire', brandTarget: 'Accessoire KURLA', hairType: '3A-4C', problem: 'Tresses qui prennent 2h, mains qui crampent, raies irrégulières', retailPriceEur: 19.9, targetCostEur: 7.5, marginPct: 55, repurchase: 'moyen', strategic: '103 refs Walmart, 1k+/mois Amazon, TikTok viral — DIY tresses en 10min, best-seller manquant #1.', pairsWith: ['p38', 'p23'] },
  { id: 'p56', name: 'Machine à locs automatique 2 aiguilles 7 vitesses (dreadlock maker)', category: 'Accessoire', brandTarget: 'Device KURLA', hairType: '4A-4C', problem: 'Entretien locs 80€ en salon, 2h de crochet manuel', retailPriceEur: 49.9, targetCostEur: 18.0, marginPct: 57, repurchase: 'moyen', strategic: '50+ vues/sem Amazon B0D8S5THXD, 2× plus rapide que manuel — niche locs peu servie EU.', pairsWith: ['p42', 'p41'] },
  { id: 'p57', name: 'Bandeau heatless satin lazy curler (Slik Satin)', category: 'Accessoire', brandTarget: 'Accessoire KURLA', hairType: '3A-4C', problem: 'Boucles sans chaleur impossibles sans passer la nuit avec bigoudis', retailPriceEur: 14.9, targetCostEur: 4.0, marginPct: 68, repurchase: 'moyen', strategic: '#1 heatless 2025 (Slik $41.75 Alibaba → sourçable $3), UGC + cadeau, marge 68%.', pairsWith: ['p22', 'p39'] },
  { id: 'p58', name: 'Brosse vapeur 2026 air cushion rechargeable USB-C', category: 'Accessoire', brandTarget: 'Device KURLA', hairType: '3A-4C', problem: 'Frisottis entre 2 lavages, brosse qui arrache', retailPriceEur: 19.9, targetCostEur: 6.5, marginPct: 61, repurchase: 'moyen', strategic: 'Tag “2026 Upgrade” Amazon 200+/mois, USB-C — upgrade de p48, moins cher.', pairsWith: ['p48', 'p32'] },
  { id: 'p59', name: 'Clips volume racines root lift 10pcs + pinces', category: 'Accessoire', brandTarget: 'Accessoire KURLA', hairType: '3A-4C', problem: 'Racines plates, volume qui retombe en 2h', retailPriceEur: 6.9, targetCostEur: 1.5, marginPct: 74, repurchase: 'moyen', strategic: 'Amazon 1k/mois root clip, add-on livraison offerte, marge 74% — déjà C9 non publié.', pairsWith: ['p16', 'p19'] },
  { id: 'p60', name: 'Chouchous soie skinny (Slip) lot 6 — édition soyeuse', category: 'Accessoire', brandTarget: 'Accessoire KURLA', hairType: '3A-4C', problem: 'Élastiques qui cassent et marquent', retailPriceEur: 9.9, targetCostEur: 1.8, marginPct: 78, repurchase: 'moyen', strategic: 'Today Award 2026, 27 couleurs Heeta — premium de p45, marge 78%.', pairsWith: ['p45', 'p17'] },
  { id: 'p61', name: 'Peigne Seashore Pik recyclé (Re-comb) — eco', category: 'Accessoire', brandTarget: 'Accessoire KURLA', hairType: '4A-4C', problem: 'Peignes qui cassent, plastique vierge', retailPriceEur: 8.9, targetCostEur: 2.0, marginPct: 73, repurchase: 'moyen', strategic: 'Harper’s Bazaar top 10 afro tools, plastique recyclé — seul argument éco de la gamme.', pairsWith: ['p35', 'p16'] },
  { id: 'p62', name: 'Analyseur cuir chevelu portable WiFi 50x/200x 4-spectres (5G)', category: 'Accessoire', brandTarget: 'Device KURLA', hairType: '3A-4C', problem: 'Ne sait pas si cuir chevelu est gras/sec, densité chute', retailPriceEur: 59.9, targetCostEur: 22.0, marginPct: 56, repurchase: 'moyen', strategic: '1 847 inquiries Ali $59, 4 spectra — hardware du diagnostic IA KURLA, upsell 19€/analyse.', pairsWith: ['p33', 'p36'] },
  { id: 'p63', name: 'Microscope cuir chevelu 1600X WiFi LED (poche)', category: 'Accessoire', brandTarget: 'Device KURLA', hairType: '3A-4C', problem: 'Chute, pellicules invisibles à l’œil nu', retailPriceEur: 29.9, targetCostEur: 12.0, marginPct: 52, repurchase: 'moyen', strategic: 'Amazon Depisuta 100+/sem, TikTok scalp check viral — version poche de p62.', pairsWith: ['p62', 'p33'] },
  { id: 'p64', name: 'Analyseur pro API 202 portable x60 (rental pro)', category: 'Accessoire', brandTarget: 'Probe / ProGen', hairType: '3A-4C', problem: 'Pros : pas de diag chiffré (densité, kératine, pore) à montrer', retailPriceEur: 199.0, targetCostEur: 120.0, marginPct: 28, repurchase: 'moyen', strategic: '$985 ProGen, x60 — rental aux pros KURLA (Nantes/Paris), 199€ location/mois, différenciation.', pairsWith: ['p62'] },
  // P2 premium affiliate / sav premium J+30
  { id: 'p65', name: 'Sèche-cheveux infrarouge AirLight Pro (L’Oréal x Zuvi)', category: 'Accessoire', brandTarget: 'L’Oréal Professionnel', hairType: '3A-4C', problem: 'Séchage agressif qui déshydrate, 30min de brushing', retailPriceEur: 199.0, targetCostEur: 110.0, marginPct: 34, repurchase: 'moyen', strategic: 'CES hydrate en séchant, -30% énergie — affiliate premium, 0 stock, ticket élevé.', pairsWith: ['p43', 'p47'] },
  { id: 'p66', name: 'Sèche-cheveux Dyson Supersonic r RFID (30% smaller)', category: 'Accessoire', brandTarget: 'Dyson', hairType: '3A-4C', problem: 'Coily dense qui met 40min à sécher', retailPriceEur: 449.0, targetCostEur: 320.0, marginPct: 14, repurchase: 'moyen', strategic: 'Dyson r divise temps coily par 2 — affiliate, effet halo premium.', pairsWith: ['p43'] },
  { id: 'p67', name: 'Sèche-cheveux T3 Aire iQ HeatID (SoftAire)', category: 'Accessoire', brandTarget: 'T3', hairType: '3A-4C', problem: 'Chaleur qui abîme, pas adaptée à la texture', retailPriceEur: 399.0, targetCostEur: 280.0, marginPct: 16, repurchase: 'moyen', strategic: 'Adapte chaleur selon cheveu, $399 Ulta — affiliate.', pairsWith: ['p43'] },
  { id: 'p68', name: 'Multi-styler Shark FlexFusion / Glam (wet-to-dry)', category: 'Accessoire', brandTarget: 'Shark Beauty', hairType: '3A-4C', problem: 'Plusieurs appareils pour 1 coiffure (lisse, boucle, volume)', retailPriceEur: 379.0, targetCostEur: 270.0, marginPct: 14, repurchase: 'moyen', strategic: 'FlexFusion wet-to-dry $379 Today Award — bundle vs Dyson Airwrap, affiliate.', pairsWith: ['p43', 'p48'] },
  { id: 'p69', name: 'Lisseur sans fil Dyson Corrale (flexing plates)', category: 'Accessoire', brandTarget: 'Dyson', hairType: '3A-4C', problem: 'Lisseur filaire qui arrache, pas de retouche', retailPriceEur: 349.0, targetCostEur: 250.0, marginPct: 14, repurchase: 'moyen', strategic: 'Flexing plates 30min sans fil — affiliate premium.', pairsWith: ['p51', 'p13'] },
  { id: 'p70', name: 'Lisseur 2-en-1 ghd Duet wet-to-dry (Airfusion)', category: 'Accessoire', brandTarget: 'ghd', hairType: '3A-4C', problem: 'Cheveux mouillés → 2 passages (séchage + lissage)', retailPriceEur: 329.0, targetCostEur: 230.0, marginPct: 16, repurchase: 'moyen', strategic: 'Airfusion 3.5x alignment, -30% énergie — affiliate.', pairsWith: ['p51'] },
  { id: 'p71', name: 'Sèche-cheveux Laifen Mini 0.5lb + Swift 4 smart temp', category: 'Accessoire', brandTarget: 'Laifen', hairType: '3A-4C', problem: 'Sèche-cheveux lourd, voyage impossible', retailPriceEur: 79.0, targetCostEur: 35.0, marginPct: 47, repurchase: 'moyen', strategic: '<9 inches, 0.5lb, smart temp — best value premium, marge 47%.', pairsWith: ['p43'] },
  { id: 'p72', name: 'Sèche-cheveux Dreame Pilot 20 AI robot (bras + red light + mist)', category: 'Accessoire', brandTarget: 'Dreame', hairType: '3A-4C', problem: 'Séchage non personnalisé, pas de soin cuir chevelu', retailPriceEur: 149.0, targetCostEur: 85.0, marginPct: 32, repurchase: 'moyen', strategic: 'CES 2026 : bras robot scan scalp + ajuste temp/airflow + red light + mist (04/2026) — teaser “bientôt”.', pairsWith: ['p62', 'p47'] },
  { id: 'p73', name: 'Lisseur infrarouge verre L’Oréal Light Straight (2027 teaser)', category: 'Accessoire', brandTarget: 'L’Oréal', hairType: '3A-4C', problem: 'Lisseur céramique qui brûle à 210°', retailPriceEur: 299.0, targetCostEur: 180.0, marginPct: 28, repurchase: 'moyen', strategic: 'CES Innovation Award, plaques verre + infrarouge basse temp — précommande teaser 2027.', pairsWith: ['p69', 'p70'] },
  { id: 'p74', name: 'Brosse ultrasonic démêlage par vibration (AI-Heat)', category: 'Accessoire', brandTarget: 'Device KURLA', hairType: '3A-4C', problem: 'Démêlage qui tire, brosse qui casse', retailPriceEur: 24.9, targetCostEur: 8.0, marginPct: 61, repurchase: 'moyen', strategic: 'Trend 2026 “AI-Heat Styler” / ultrasonic — démêle sans traction, étanche.', pairsWith: ['p16', 'p20'] },
  { id: 'p75', name: 'Brosse soufflante 6-en-1 1000W multi-styler', category: 'Accessoire', brandTarget: 'Accessoire KURLA', hairType: '3A-4C', problem: '6 appareils pour 1 blowout', retailPriceEur: 29.9, targetCostEur: 12.0, marginPct: 52, repurchase: 'moyen', strategic: 'Alibaba $19.50 4.2★ 36 avis — version accessible du Shark FlexFusion.', pairsWith: ['p43', 'p71'] },
  { id: 'p76', name: 'Steamer salon sur pied nano micro mist 4 wheels (pro)', category: 'Accessoire', brandTarget: 'Device KURLA', hairType: '3A-4C', problem: 'Salon : pas de vapeur pro pour soin profond', retailPriceEur: 249.0, targetCostEur: 160.0, marginPct: 23, repurchase: 'moyen', strategic: '30x32x77cm pro use $240 Ali — offre KURLA Pro location salon, 0 stock chez toi.', pairsWith: ['p47', 'p44'] },
  { id: 'p77', name: 'Machine dreadlock 3 aiguilles handheld $204 (pro locs)', category: 'Accessoire', brandTarget: 'Device KURLA', hairType: '4A-4C', problem: 'Dreadlocks manuels 3h, résultat irrégulier', retailPriceEur: 59.9, targetCostEur: 32.0, marginPct: 36, repurchase: 'moyen', strategic: 'Amazon $204 stainless 3 needles — version pro de p56, location pro.', pairsWith: ['p56', 'p42'] },
];
