...
const skinLabels: Array<[string, string]> = [
  ...
  ['skin.skinType', 'type de peau'], ['skin.hydrationLevel', 'niveau d’hydratation'], ['skin.skinConcerns', 'préoccupations peau'], ['skin.skinObjectives', 'objectifs peau'], ['skin.currentRoutine', 'routine actuelle'], ['skin.budget', 'budget peau'], ['skin.sensitivities', 'sensibilités connues'], ['skin.preferences', 'préférences peau'], ['skin.ageRange', 'tranche d’âge']
];
