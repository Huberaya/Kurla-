...
const NEED_LEXICON: { need: string; terms: string[] }[] = [
  ...
  { need: 'definir_boucles', terms: ['définition', 'definition', 'boucle', 'curl', 'dessiner', 'twist', 'coils'] },
  { need: 'reduire_frisottis', terms: ['frisotti', 'frizz', 'mousseux', 'frisottis'] },
  { need: 'cuir_chevelu', terms: ['cuir chevelu', 'scalp'] },
  { need: 'apaiser_cuir_chevelu', terms: ['démangeai', 'demangeai', 'itch', 'pellicul', 'irrit', 'apaiser'] },
  { need: 'demeler_cheveux', terms: ['démêl', 'demel', 'nœud', 'noeud', 'emêl', 'detangle', 'peigne', 'brosse'] },
  { need: 'proteger_nuit', terms: ['nuit', 'bonnet', 'satin', 'taie', 'oreiller', 'night', 'durag'] },
  { need: 'entretenir_tresses', terms: ['tresse', 'braid', 'knotless', 'vanille', 'protective', 'natte'] },
  { need: 'entretenir_locks', terms: ['locks', 'dread', 'locs', 'interlock', 'twist sponge', 'freeform'] },
  { need: 'entretenir_perruque', terms: ['perruque', 'wig', 'lace', 'tissage', 'extension'] },
  { need: 'barbe', terms: ['barbe', 'beard', 'grooming', 'homme', 'waves', 'moustache'] },
  { need: 'proteger_chaleur', terms: ['chaleur', 'lisseur', 'sèche-cheveux', 'seche-cheveux', 'heat', 'thermo', 'vapeur', 'steamer'] },
