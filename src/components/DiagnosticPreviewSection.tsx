...
export const DiagnosticPreviewSection: React.FC = () => {
  return (
    <section className="py-24 bg-kurla-sand text-kurla-carbon relative border-t border-kurla-stone overflow-hidden">
      {/* Background Ambient Glow */}
      <div className="absolute top-1/2 left-0 w-96 h-96 bg-kurla-copper/10 rounded-full blur-3xl pointer-events-none" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-6 space-y-6">
            <span className="text-xs uppercase tracking-widest text-kurla-copper font-semibold flex items-center gap-2">
              <Sparkles className="w-4 h-4 text-kurla-copper" /> Diagnostic personnalisé &amp; gratuit
            </span>
            ...
            <p className="text-base text-kurla-carbon/80 max-w-[520px] font-light leading-relaxed">
            ...
            <div className="p-4 rounded-2xl bg-kurla-ivory border border-kurla-stone flex items-start gap-3 text-xs text-kurla-carbon/70 max-w-[520px] shadow-xs">
              <ShieldAlert className="w-4 h-4 text-kurla-copper shrink-0 mt-0.5" />
              <span>
