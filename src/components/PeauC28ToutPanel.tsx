    ...
    <div className="rounded-3xl bg-[#1A0F0A] border border-[#FFF7EF]/10 p-6 sm:p-8 space-y-7 shadow-xl">
      <div className="flex items-start justify-between gap-4 flex-wrap">
        <div>
          <h3 className="text-lg font-serif-title font-bold text-[#FFF7EF] flex items-center gap-2">
            <Crown className="w-5 h-5 text-[#C8753D]" /> C28 — Les 4 derniers chantiers : CI/MA/CH/CM + HPI IA + SOP ops + finance (tout)
          ...
          <p className="text-xs text-[#FFF7EF]/60 mt-1 max-w-3xl leading-relaxed">
            Fermeture P1 : <strong className="text-[#FFF7EF]">CI/MA/CH/CM gating chiffré</strong> + <strong className="text-[#FFF7EF]">HPI tracker photo IA V2</strong> + <strong className="text-[#FFF7EF]">SOP ops 3–5j lun/jeu</strong> + <strong className="text-[#FFF7EF]">finance breakeven 90j</strong>. Scale seulement si CI&gt;MA&gt;CH&gt;CM par preuves — pas par continent.
          </p>
        </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
        <div className="p-3 rounded-2xl bg-[#050403] border border-[#FFF7EF]/10 text-center">
          <p className="text-[10px] uppercase tracking-wider text-[#D49A63] font-bold flex items-center justify-center gap-1"><Globe className="w-3 h-3" /> CI 68 / MA 64</p>
          <p className="text-lg font-bold text-[#FFF7EF]">{verts}/4 <span className="text-xs font-normal opacity-60">pays</span></p>
          <p className="text-[10px] text-[#FFF7EF]/40">SN71 → CI68</p>
        </div>
        <div className="p-3 rounded-2xl bg-[#050403] border border-sky-500/20 text-center">
          ...
          <p className="text-[10px] text-[#FFF7EF]/40">V2 photo delta P2</p>
        </div>
        <div className="p-3 rounded-2xl bg-[#050403] border border-[#FFF7EF]/10 text-center">
          ...
          <p className="text-[10px] text-[#FFF7EF]/40">gates · lun/jeu 18h</p>
        </div>
        <div className="p-3 rounded-2xl bg-amber-500/10 border border-amber-500/20 text-center">
          ...
          <p className="text-[10px] text-[#FFF7EF]/40">LTV {ltv}€ · BE {be?.orders ?? '—'} cmd</p>
        </div>
      </div>
      ...
      <div className="grid lg:grid-cols-2 gap-4">
        ...
        <div className="p-4 rounded-2xl bg-[#050403] border border-[#FFF7EF]/10 space-y-3">
          <h4 className="text-sm font-bold text-[#FFF7EF] flex items-center gap-2"><Globe className="w-4 h-4 text-[#C8753D]" /> Expansion CI/MA/CH/CM — gating chiffré (pas continent)</h4>
          <div className="overflow-x-auto">
            <table className="w-full text-left text-xs border-collapse min-w-[520px]">
              <thead><tr className="border-b border-[#FFF7EF]/10 text-[#D49A63] uppercase tracking-wider text-[10px]"><th className="py-2 px-2">Pays · score</th><th className="py-2 px-2">Dispatch</th><th className="py-2 px-2">Condition</th><th className="py-2 px-2">Gate</th></tr></thead>
              <tbody className="divide-y divide-[#FFF7EF]/5">
                {[
                  ...
                  <tr key={cfg.code} className={ok?'bg-emerald-950/10':''}>
                    <td className="py-2 px-2"><span className="font-bold text-[#FFF7EF] flex items-center gap-1">{cfg.flag} {cfg.code} {cfg.score}<span className={`ml-1 px-1 py-0.5 rounded-full border text-[10px] ${ok?'bg-emerald-500/15 text-emerald-300 border-emerald-500/30':'bg-[#FFF7EF]/5 text-[#FFF7EF]/40 border-[#FFF7EF]/10'}`}>{ok?'GO':'VEILLE'}</span></span><span className="text-[10px] text-[#FFF7EF]/40">{cfg.currency} · TVA {cfg.vatRate}%</span></td>
                    <td className="py-2 px-2 text-[#FFF7EF]/70 leading-snug">{cfg.dispatchDays} · {cfg.hub}</td>
                    <td className="py-2 px-2 text-[11px] text-[#FFF7EF]/60 leading-snug">{cfg.condition}</td>
          ...
          <p className="text-[11px] text-[#FFF7EF]/35 leading-relaxed">Source <code className="px-1 py-0.5 rounded bg-[#1A0F0A] border border-[#FFF7EF]/10">countryFulfillment.ts</code> · Règle : score≥65 + preuve MOQ. Actuel : SN71 veille (0 MOQ Afrique) → CI68 bloqué (voulu). CH58 bloqué (BE {paid}/50).</p>
        </div>
        ...
        <div className="p-4 rounded-2xl bg-[#050403] border border-sky-500/20 space-y-3">
          ...
          <div className="grid sm:grid-cols-2 gap-3 text-xs">
            <div className="p-3 rounded-xl bg-sky-950/20 border border-sky-500/20">
              ...
              <ul className="list-disc list-inside text-[#FFF7EF]/70 mt-1 space-y-0.5 leading-relaxed">
            ...
            <div className="p-3 rounded-xl bg-[#1A0F0A] border border-[#FFF7EF]/10">
              <p className="font-bold text-[#FFF7EF] flex items-center gap-1"><Eye className="w-3.5 h-3.5" /> V2 P2 (moat)</p>
              <ul className="list-disc list-inside text-[#FFF7EF]/60 mt-1 space-y-0.5 leading-relaxed">
          ...
          <div className="p-3 rounded-xl bg-emerald-950/15 border border-emerald-500/15 text-xs leading-relaxed">
            ...
            <p className="text-[#FFF7EF]/70 mt-1">uniformiser≠éclaircir 0 occ · HPI : inflammation → niacinamide/céramides (jamais diag) · SPF whitecast V-VI faible ISO24444 · rétinol×AHA alterner — <code className="px-1 py-0.5 rounded bg-[#050403] border border-[#FFF7EF]/10">/assistant</code> + <code>/peau/journal</code> synthèse.</p>
          </div>
        </div>
        ...
        <div className="p-4 rounded-2xl bg-[#050403] border border-emerald-500/20 space-y-3">
          ...
          <div className="p-3 rounded-xl bg-emerald-950/10 border border-emerald-500/15 text-xs leading-relaxed">
            <p className="font-bold text-[#FFF7EF]">Boucle sans stock Paris</p>
            <ol className="list-decimal list-inside text-[#FFF7EF]/70 mt-1 space-y-0.5">
            ...
            <p className="text-[11px] text-[#FFF7EF]/40 mt-2">Demande live {demandUnits}u · gates {peauGatesOk}/{gatesTotal} · paid {paid} · email {metrics?.emailHealth || '—'}</p>
          </div>
          <div className="grid grid-cols-2 gap-2 text-xs text-center">
            <div className="p-2 rounded-xl bg-[#1A0F0A] border border-[#FFF7EF]/10"><p className="text-[10px] uppercase tracking-wider text-[#FFF7EF]/50">3PL IDF</p><p className="text-sm font-bold text-[#FFF7EF]">60% 24–48h</p><p className="text-[10px] text-[#FFF7EF]/35">95 Etx Logistique</p></div>
            <div className="p-2 rounded-xl bg-[#1A0F0A] border border-[#FFF7EF]/10"><p className="text-[10px] uppercase tracking-wider text-[#FFF7EF]/50">SAV</p><p className="text-sm font-bold text-sky-300">{metrics?.openTicketsCount ?? 0} tickets</p><p className="text-[10px] text-[#FFF7EF]/35">open/in_progress</p></div>
          </div>
        </div>
        ...
        <div className="p-4 rounded-2xl bg-[#050403] border border-amber-500/20 space-y-3">
          ...
          <div className="grid grid-cols-3 gap-2 text-center text-xs">
            ...
            <div className="p-2 rounded-xl bg-[#1A0F0A] border border-[#FFF7EF]/10"><p className="text-[10px] uppercase tracking-wider text-[#FFF7EF]/50">Marge</p><p className="text-lg font-bold text-emerald-300">52%</p><p className="text-[10px] text-[#FFF7EF]/35">HT 22/30/40</p></div>
          ...
          <div className="p-3 rounded-xl bg-[#1A0F0A] border border-[#FFF7EF]/10 text-xs leading-relaxed">
            ...
            <div className="mt-2 flex flex-wrap gap-1.5 text-[11px]">
              ...
              <span className="px-2 py-1 rounded-full bg-[#050403] border border-[#FFF7EF]/10 text-[#FFF7EF]/60">Port 4,90€ / gratuit 60/80€</span>
              <span className="px-2 py-1 rounded-full bg-[#050403] border border-[#FFF7EF]/10 text-[#FFF7EF]/60">Stock TEST 0€ → 8 640€ M3</span>
            </div>
          </div>
          <p className="text-[11px] text-[#FFF7EF]/40 leading-relaxed">Sources : <code className="px-1 py-0.5 rounded bg-[#1A0F0A] border border-[#FFF7EF]/10">businessStrategy.ts</code> FINANCE_PROJECTION + BREAKEVEN + <code className="px-1 py-0.5 rounded bg-[#1A0F0A] border border-[#FFF7EF]/10">/api/admin/metrics</code> (AOV/LTV/repeat) — hypothèses assumées, réel corrige.</p>
        </div>
      </div>

      <div className="flex flex-wrap gap-2">
        <button onClick={()=>copy(copy28,'c28')} className="px-3 py-1.5 rounded-full bg-[#C8753D] hover:bg-[#D49A63] text-white text-xs font-bold flex items-center gap-1.5">
        ...
        <span className="text-[11px] text-[#FFF7EF]/35 self-center">C28 = P1 close — scale CI/MA/CH/CM seulement sur preuves chiffrées.</span>
      </div>
