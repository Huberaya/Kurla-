...
export const DiagnosticSkinPage: React.FC = () => {
  ...
  const concernOptions: Array<{ id: string; label: string; desc: string }> = [
    ...
    { id: 'assombrissement_plis', label: 'Assombrissement des plis (cou, aisselles, cuisses)', desc: 'Frottement + transpiration, pas de l’hygiène' },
    ...
    { id: 'leveres_assombries', label: 'Lèvres qui se gercent ou foncent', desc: 'Lécher, soleil, produits' },
