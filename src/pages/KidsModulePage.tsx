    ...
    <div className="pt-28 pb-24 bg-kurla-ivory text-kurla-carbon min-h-screen">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="rounded-3xl bg-kurla-sand border border-kurla-stone p-8 sm:p-12 mb-12 flex flex-col md:flex-row items-center gap-8 shadow-sm">
          <div className="flex-1 space-y-4">
            ...
            <div className="flex flex-wrap gap-3 pt-2">
              ...
              >
                <BookOpen className="w-4 h-4 text-kurla-copper" /> Poser une question à l'IA Kids
              </a>
              <a href="/famille" className="px-6 py-3.5 rounded-full border border-kurla-copper/40 text-kurla-copper text-xs font-semibold flex items-center gap-2"><Heart className="w-4 h-4" /> Créer un espace famille</a>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
          ...
          <div className="p-6 rounded-3xl bg-kurla-ivory border border-kurla-stone shadow-xs">
            <div className="w-10 h-10 rounded-2xl bg-kurla-copper/10 text-kurla-copper flex items-center justify-center font-bold mb-4">
              <Clock className="w-5 h-5" />
            </div>
            <h3 className="text-base font-serif-title font-bold text-kurla-carbon mb-2">
              Routines adaptées à l’âge
            </h3>
            <p className="text-xs text-kurla-carbon/70 font-light leading-relaxed">
        ...
        {/* Parent FAQs Section */}
        <div className="p-8 rounded-3xl bg-kurla-sand border border-kurla-stone mb-12">
          <h2 className="text-xl font-serif-title font-bold text-kurla-carbon mb-6">
            Questions Fréquentes des Parents :
          </h2>

          <div className="space-y-4 text-xs">
            <div className="p-4 rounded-2xl bg-kurla-ivory border border-kurla-stone">
              <span className="font-bold text-kurla-carbon block mb-1">
                Mon enfant pleure dès que je sors la brosse, que faire ?
              </span>
              <p className="text-kurla-carbon/70 font-light leading-relaxed">
        ...
        <div className="grid md:grid-cols-3 gap-4 mb-12">
          <div className="p-5 rounded-2xl bg-white border border-kurla-stone text-xs"><strong className="block mb-2">Bébés</strong><p className="text-kurla-carbon/65">Priorité à la douceur, à la supervision et à la vérification de l’âge recommandé. Aucun actif adulte par défaut.</p></div>
          <div className="p-5 rounded-2xl bg-white border border-kurla-stone text-xs"><strong className="block mb-2">Enfants</strong><p className="text-kurla-carbon/65">Routines simples, accessoires adaptés et temps de soin réaliste, sans photo ni donnée d’enfant nécessaire.</p></div>
          <div className="p-5 rounded-2xl bg-white border border-kurla-stone text-xs"><strong className="block mb-2">Adolescents</strong><p className="text-kurla-carbon/65">Plus d’autonomie, mais toujours un profil séparé et des produits dont la sécurité mineur est documentée.</p></div>
        </div>
