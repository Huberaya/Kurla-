        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
          <div className="lg:col-span-5 space-y-3">
            <div className="relative aspect-square rounded-3xl overflow-hidden border border-[#FFF7EF]/10 bg-[#1A0F0A]">
              {currentImage?.url ? <img src={currentImage.url} alt={currentImage.label || product.name} className="w-full h-full object-cover" referrerPolicy="no-referrer" /> : <div className="w-full h-full flex items-center justify-center text-sm text-[#FFF7EF]/50"><ImageIcon className="w-5 h-5 mr-2" /> Image en attente de validation</div>}
