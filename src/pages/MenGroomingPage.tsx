      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="rounded-3xl bg-kurla-sand border border-kurla-stone p-8 sm:p-12 mb-12 flex flex-col md:flex-row items-center gap-8 shadow-sm">
          <div className="flex-1 space-y-4">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-kurla-carbon text-white text-xs font-semibold">
              <Scissors className="w-4 h-4 text-kurla-copper" /> Hommes Grooming & Barbershop
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          <div className="p-6 rounded-3xl bg-kurla-ivory border border-kurla-stone">
            <span className="text-xs font-bold text-kurla-copper uppercase block mb-1">Étape 1</span>
            <h3 className="text-base font-bold text-kurla-carbon mb-2">Nettoyer & Apaiser le Rasage</h3>
          ...
          <div className="p-6 rounded-3xl bg-kurla-ivory border border-kurla-stone">
            <span className="text-xs font-bold text-kurla-copper uppercase block mb-1">Étape 2</span>
            <h3 className="text-base font-bold text-kurla-carbon mb-2">Hydrater la Barbe & Waves</h3>
            <p className="text-xs text-kurla-carbon/70 font-light leading-relaxed">
          ...
          <div className="p-6 rounded-3xl bg-kurla-ivory border border-kurla-stone">
            <span className="text-xs font-bold text-kurla-copper uppercase block mb-1">Étape 3</span>
            <h3 className="text-base font-bold text-kurla-carbon mb-2">Brosser & Compresser (Durag)</h3>
            <p className="text-xs text-kurla-carbon/70 font-light leading-relaxed">
        ...
        <section className="space-y-6">
          <div><span className="text-xs uppercase tracking-widest text-kurla-copper font-bold">Explorer par besoin</span><h2 className="text-2xl font-serif-title font-bold mt-1">Le grooming ne se résume pas à la barbe.</h2><p className="text-sm text-kurla-carbon/65 mt-2">Chaque espace pourra afficher uniquement les produits et conseils dont le public, les ingrédients et les précautions sont documentés.</p></div>
          ...
          ].map(([title, description]) => <div key={title} className="p-5 rounded-2xl bg-kurla-sand border border-kurla-stone hover:border-kurla-copper transition-colors"><h3 className="font-semibold text-sm">{title}</h3><p className="text-xs text-kurla-carbon/60 mt-2 leading-relaxed">{description}</p><ArrowRight className="w-4 h-4 text-kurla-copper mt-4" /></div>)}</div>
